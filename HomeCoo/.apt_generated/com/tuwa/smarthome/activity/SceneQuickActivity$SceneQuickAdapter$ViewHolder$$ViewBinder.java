...
public class SceneQuickActivity$SceneQuickAdapter$ViewHolder$$ViewBinder<T extends com.tuwa.smarthome.activity.SceneQuickActivity.SceneQuickAdapter.ViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131231876, "field 'cbSceneQuick'");
    target.cbSceneQuick = finder.castView(view, 2131231876, "field 'cbSceneQuick'");
